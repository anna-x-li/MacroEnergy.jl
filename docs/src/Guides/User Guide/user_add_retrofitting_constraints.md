...
1. Turn on the retrofitting setting in the macro_settings file
2. Make your JSON file for your asset that can be retrofitted into another asset
3. Make your JSON file for the retrofitting asset
