...
With the above settings, Macro will start the myopic iteration from period 2, loading planning solutions from folder "results" and it will terminate the iterations after period 3 has been solved.
